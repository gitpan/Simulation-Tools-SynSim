package Simulation::Tools::SynSim::Analysis;
...
$Id: Analysis.pm,v 1.4 2002/10/16 15:27:39 wim Exp $
...
@Simulation::Tools::SynSim::Analysis::ISA = qw(Exporter);
@Simulation::Tools::SynSim::Analysis::EXPORT = qw(
		     &calc_statistics
		     &build_histograms
                  );
